...
const Home2: React.FC<HomeProps> = ({ cityName = "Seguin" }) => {
  const isDallas = cityName === "Seguin";
          ...
          <div className="space-y-20">
            ...
            <div className="flex flex-col gap-12 border-t border-gray-200 pt-20">
              <div className="group">
                ...
                <a href="tel:(830) 266-5486" className="text-4xl font-light hover:italic transition-all text-black underline underline-offset-[12px] decoration-blue-200">743.228.2305</a>
              </div>
            </div>
          </div>
