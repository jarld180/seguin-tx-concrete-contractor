...
const Home3: React.FC<HomeProps> = ({ cityName = "Seguin" }) => {
  const mapUrl = cityName === "Seguin" 
    ? "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3263.1!2d-97.9647!3d29.5688!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8854210909090909%3A0x8854210909090909!2sDallas%2C%20TX!5e0!3m2!1sen!2sus!4v1704576000000!5m2!1sen!2sus"
    : `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100000!2d-97.9647!3d29.5688!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8854000000000000%3A0x0000000000000000!2s${encodeURIComponent(cityName)}%2C%20TX!5e0!3m2!1sen!2sus!4v1704576000000!5m2!1sen!2sus`;
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div data-aos="fade-right" data-aos-duration="1000">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Link to={cityName === "Seguin" ? "/driveways" : `/${cityName.toLowerCase().replace(" ", "-")}/driveways`} className="bg-white border-2 border-black text-black px-8 py-4 rounded-2xl font-bold text-center hover:border-black transition-all">
                  Our Work
                </Link>
              </div>
            </div>
          ...
          <div className="space-y-32">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <Link to={cityName === "Seguin" ? "/driveways" : `/${cityName.toLowerCase().replace(" ", "-")}/driveways`} className="font-bold flex items-start group text-black">
              ...
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/driveways/option 2.png" alt="Concrete Driveway Seguin TX" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/foundations/option 2.jpg" alt="Foundations Seguin TX" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                ...
                <Link to={cityName === "Seguin" ? "/foundations" : `/${cityName.toLowerCase().replace(" ", "-")}/foundations`} className="font-bold flex items-start group text-black">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <p className="text-black text-lg leading-relaxed mb-8">
                  Choose from our signature {cityName} collections, including Historic Seguin Slate and Trinity Wood Plank, all finished with UV-resistant pigments and high-solids solvent sealers.
                </p>
                <Link to={cityName === "Seguin" ? "/patios" : `/${cityName.toLowerCase().replace(" ", "-")}/patios`} className="font-bold flex items-start group text-black">
                  Design Your Outdoor Oasis <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/patios/option 2.jpg" alt="Stamped Patios Seguin TX" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/pool-decks/option 2.jpg" alt="Pool Decks Seguin TX" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                  <Logo className="text-black w-8 h-8" />
                ...
                <Link to={cityName === "Seguin" ? "/pool-decks" : `/${cityName.toLowerCase().replace(" ", "-")}/pool-decks`} className="font-bold flex items-start group text-black">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="order-2 md:order-1">
                ...
                <Link to={cityName === "Seguin" ? "/garage-floors" : `/${cityName.toLowerCase().replace(" ", "-")}/garage-floors`} className="font-bold flex items-start group text-black">
                  Upgrade Your Garage <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
              <div className="order-1 md:order-2 overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/garage-floors/option 2.jpg" alt="Garage Floors Seguin TX" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start" data-aos="fade-up">
              <div className="overflow-hidden rounded-[40px] shadow-2xl">
                <img src="/services/sidewalks/option 2.jpg" alt="Sidewalks Seguin TX" className="w-full h-[600px] object-cover hover:scale-105 transition-transform duration-700" />
              </div>
              <div>
                <div className="flex items-start space-x-3 mb-6">
                ...
                <Link to={cityName === "Seguin" ? "/sidewalks" : `/${cityName.toLowerCase().replace(" ", "-")}/sidewalks`} className="font-bold flex items-start group text-black">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div data-aos="fade-left">
              ...
              <p className="text-xl text-black mb-6 leading-relaxed">
                Founded on the principles of integrity and technical mastery, Seguin Concrete has grown into DFW Metroplex's most trusted partner for high-end residential and commercial builds.
              </p>
      ...
      <section id="testimonials" className="py-32 bg-gray-50 overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-black" data-aos="fade-up" data-aos-delay="100">See why your neighbors in DFW Metroplex choose Seguin Concrete.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { text: "Their team handled the foundation for our custom home in Grand Prairie perfectly. The level of communication was outstanding.", author: "Michael S., Seguin, TX" },
              { text: "The new stamped patio they designed for us in Fort Worth is beautiful. It's completely changed how we use our backyard.", author: "Sarah J., Seguin, TX" },
              { text: "Professional, clean, and fast. They replaced our long driveway in Legacy West in just three days. Highly recommend.", author: "Robert D., Seguin, TX" },
              { text: "Best concrete contractors in Seguin. They did our garage floor with polyaspartic coating and it looks like a showroom.", author: "James L., Seguin, TX" },
              ...
              { text: "High quality work and very professional crew. They handled all the permitting for our new sidewalk on Trade St.", author: "David K., Downtown Seguin" },
              ...
              { text: "Amazing transformation of our old cracked driveway. The new finish with the picture frame border is stunning.", author: "Nancy T., Seguin, TX" },
              ...
              { text: "Excellent customer service. They took the time to explain all our decorative options for the back patio.", author: "Steven R., Seguin, TX" }
            ].map((t, i) => (
      ...
      <section id="faq" className="py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            {[
              { q: "How long does a standard driveway project take?", a: "Typically, a full driveway replacement in Seguin takes between 3 to 5 days, depending on weather and site preparation requirements." },
              ...
              { q: "Do you handle local permits and inspections?", a: "Yes, we manage all coordination with the Town of Seguin and DFW Metroplex building departments, including 811 utility locates and final inspections." },
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-white">(830) 266-5486</p>
                  </div>
                </div>
                <div className="flex items-start space-x-6">
                  <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-start justify-center">
