    ...
    <footer className="bg-white py-20 border-t border-gray-100">
      <div className="max-w-[1600px] mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            ...
            <p className="text-black text-lg mb-8 max-w-sm">
              Seguin's premier concrete contractors specializing in high-end residential and commercial projects. Building foundations for a lifetime.
            </p>
          </div>
          <div>
        ...
        <div className="pt-12 border-t border-gray-100 flex flex-col md:flex-row justify-between items-start text-sm text-black">
          <p>© 2026 Seguin Concrete. All rights reserved. (830) 266-5486</p>
